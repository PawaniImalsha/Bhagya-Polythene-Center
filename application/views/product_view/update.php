...
<br>
<div class="container">
<?php echo form_open('Home/update',['class'=>'form-horizontal']); ?>
  <fieldset>
<hr>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <?php echo form_input(['name'=>'productName','class'=>'form-control','placeholder'=>'Product Name','value'=>set_value('productName', $record->productName)]); ?>
      </div>
    </div>
    </div>
    <div class="col-lg-6">
...
<div class="row">
      ...
      <div class="col-lg-8">
        ...
        <?php echo form_input(['name'=>'productSize','class'=>'form-control','placeholder'=>'Product Size','value'=>set_value('productSize',$record->productSize)]); ?>
      </div>
    </div>
    </div>
    <div class="col-lg-6">
  ...
  <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <?php echo form_input(['name'=>'productPrice','class'=>'form-control','placeholder'=>'Product Price','value'=>set_value('productPrice',$record->productPrice)]); ?>
      </div>
    </div>
    </div>
    <div class="col-lg-4">
